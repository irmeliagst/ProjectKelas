...
import com.amel.kedua.adapter.RecentsAdapter;
import com.amel.kedua.adapter.TopPlacesAdapter;
import com.amel.kedua.model.RecentsData;
import com.amel.kedua.model.TopPlacesData;
...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recentsDataList.add(new RecentsData("AM Lake","India","From $200",R.drawable.kamar1));
        recentsDataList.add(new RecentsData("Nilgiri Hills","India","From $300",R.drawable.kamar1));
        recentsDataList.add(new RecentsData("AM Lake","India","From $200",R.drawable.kamar1));
        recentsDataList.add(new RecentsData("Nilgiri Hills","India","From $300",R.drawable.kamar1));
        recentsDataList.add(new RecentsData("AM Lake","India","From $200",R.drawable.kamar1));
        recentsDataList.add(new RecentsData("Nilgiri Hills","India","From $300",R.drawable.kamar1));
...
//
//        topPlacesRecycler = findViewById(R.id.recent_recycler);
